        ...
        child: Scaffold(
          floatingActionButtonLocation: FloatingActionButtonLocation.centerFloat,
            floatingActionButton: Padding(
              ...
              child: MainAppBtn(title: 'طلب عرض منتج',onTap: (){

                Navigator.push(context, MaterialPageRoute(builder: (_) => OrderShowProduct()  ));
            ...
            body:  Padding(
              ...
              child: Column(
                ...
                children: [
                  CustomAppBar(title: 'بيع المنتجات'),
                  Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  // mainAxisAlignment: MainAxisAlignment.end,
                  children: [
                    SvgPicture.asset(AppImages.pin, color: Colors.grey[600]),
                    const SizedBox(width: 8),
                    const Text('الرياض', style: TextStyle(color: Colors.grey, fontSize: 14)),
                  ],
                ),
