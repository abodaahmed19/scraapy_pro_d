...
class InspectionDemolitionMenu extends StatelessWidget {
  InspectionDemolitionMenu({super.key});

  var menuItem = [
    {
      "title":"العمليات المعلقة",
      "icon":"${AppImages.pending_operation}",
      "page":SellingPayListScreen(title: "العمليات المعلقة",fromInspection: true,),


    },
    {
      "title":"العمليات السابقة",
      "icon":"${AppImages.previous_operation}",
      "page":SellingPayListScreen(title: "مستاجرة",)
      ...
      child: Scaffold(
        ...
        body: Padding(
          ...
          child: ListView(
            ...
            children: [
              CustomAppBar(title: 'الفحص والهدم',),
              // PersonalInfoWidget(),
