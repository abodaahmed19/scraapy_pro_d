...
class ScraapyContracts extends StatelessWidget {
  const ScraapyContracts({super.key});
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Text('وساطة سكرابي',style: TextStyle(fontWeight: FontWeight.w500,fontSize: 16,color: AppColors.primary),),
                  SizedBox(height: 16,),
                  Row(
                    children: [
                  ...
                  Row(
                    children: [
                      Icon(Icons.circle,color: AppColors.terquaz,size: 10,),
                      SizedBox(width: 6,),
                      Text('الطرف الأول (منتج النفايات)',style:
                      TextStyle(fontWeight: FontWeight.w500,fontSize: 12,color: AppColors.primary),),

                    ],
                  ),
                  SizedBox(height: 12,),
                  CustomTextField(hint: 'ادخل اسم المنتج',label: 'اسم منتج النفايات',),
                  CustomTextField(hint: 'ادخل رقم السجل',label: 'السجل التجاري',),
                  CustomTextField(hint: 'ادخل الرقم الضريبي',label: 'الرقم الضريبي',),
                  ...
                  Row(
                    children: [
                      Icon(Icons.circle,color: AppColors.terquaz,size: 10,),
                      SizedBox(width: 6,),
                      Text('الطرف التالت (المشتري)',style:
                      TextStyle(fontWeight: FontWeight.w500,fontSize: 12,color: AppColors.primary),),

                    ],
                  ),
                  SizedBox(height: 12,),
                  CustomTextField(hint: 'ادخل اسم المشتري',label: 'اسم المشتري',),
                  CustomTextField(hint: 'ادخل رقم السجل',label: 'السجل التجاري',),
                  CustomTextField(hint: 'ادخل الرقم الضريبي',label: 'الرقم الضريبي',),
                  ...
                  SizedBox(height: 12,),
                  CustomTextField(hint: 'ادخل اسم المشتري',label: 'الأشتراك الثانوي لمنتج النفايات (ريال)',),
                  CustomTextField(hint: 'ادخل رقم السجل',label: 'الأشتراك الثانوي للمشتري (ريال)',),
                  CustomTextField(hint: 'ادخل الرقم الضريبي',label: 'نسبة رسوم المعاملة(%)',),
