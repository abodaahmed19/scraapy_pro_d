...
class FavoriteRemoteDataSourceImpl implements FavoriteRemoteDataSource {
  ...
  //   final response = await dio.get('https://vmi2584358.contaboserver.net/api/inventory/favorites/');
  //
  //   return List<FavoriteItemModel>.from(
  //     response.data.map((e) => FavoriteItemModel.fromJson(e)),
  //   );  }
  ...
  Future<List<FavoriteItemModel>> getFavorites() async {
    try {
      ...
      final response = await dio.get(
        '${ConstantManager.baseUrl}/inventory/favorites/',
      );
      ...
      /// 🔥 Error handling احترافيdio.hashCode
      print(e);
      if (e.response != null) {
