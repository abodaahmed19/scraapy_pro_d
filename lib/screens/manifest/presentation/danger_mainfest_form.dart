...
class DangerMainfestForm extends StatelessWidget {
  const DangerMainfestForm({super.key});
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('مانيفيست نقل النفايات الخطرة',style: TextStyle(fontWeight: FontWeight.w500,fontSize: 16,color: AppColors.primary),),
                      SizedBox(height: 12,),
                      Row(
                        children: [
